...
\address{Instituto de Informática/Departamento de Engenharia Elétrica \\  Universidade Federal do Rio Grande do Sul
  (UFRGS)
...
\input{text/codigo.tex}
\input{text/consideracoes.tex}
